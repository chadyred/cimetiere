 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Cimetiere\Bundle\Entity\DefuntRepository")
 */
class Defunt
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="codeGestionConcession", type="string", length=20, nullable=true)
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Cimetiere\Bundle\Entity\Concession", inversedBy="defunts", cascade={"persist","remove"})
     */
    private $concession;
     ...
     * Set concession
     *
     * @param \Cimetiere\Bundle\Entity\Concession $concession
     * @return Defunt
     */
    public function setConcession(\Cimetiere\Bundle\Entity\Concession $concession = null)
    {
     ...
     * Get concession
     *
     * @return \Cimetiere\Bundle\Entity\Concession 
     */
    public function getConcession()
    {
     ...
     public function __toString() {
        return $this->codeGestionConcession." ".$this->nomPrenom;
    }
}

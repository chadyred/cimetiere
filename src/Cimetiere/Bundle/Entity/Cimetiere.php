...
class Cimetiere
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Cimetiere\Bundle\Entity\Ville", inversedBy="cimetieres", cascade={"persist"})
     */
    private $ville;
    
    /**
     * @ORM\OneToMany(targetEntity="Cimetiere\Bundle\Entity\Concession", mappedBy="cimetiere", cascade={"persist","remove"})
     */
    private $concessions;
